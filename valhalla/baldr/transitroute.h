...
public:
  ...
  /**
   * Get the TPP onestopId offset for this route.
   * @return  Returns the TPP onestopId offset.
   */
  ...
  /**
   * Get the TPP operator onestopId offset for this route.
   * @return  Returns the TPP operator onestopId offset.
   */
  ...
  /**
   * Get the TPP operator name offset for this route.
   * @return  Returns the TPP operator name offset.
   */
  ...
  /**
   * Get the TPP operator website offset for this route.
   * @return  Returns the TPP operator website offset.
   */
...
protected:
  ...
  uint64_t one_stop_offset_ : 24; // TPP onestop Id for this route.
  uint64_t spare1_ : 32;

  uint64_t op_by_onestop_id_offset_ : 24; // TPP operated by onestop id.
  uint64_t op_by_name_offset_ : 24;       // TPP operated by name.
  uint64_t spare2_ : 16;

  uint64_t op_by_website_offset_ : 24; // TPP operated by website.
